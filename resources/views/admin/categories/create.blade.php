...
<head>
    ...
    <meta name="description" content="Create Category - Admin Panel">

    <title>Create Category - {{ config('app.name', 'EventTicket') }}</title>
    ...
    {{-- =======================================================================
         2. CUSTOM STYLES (Category Genesis Theme)
    ======================================================================= --}}
    <style>
        ...
        .glass-input:focus {
            background: #ffffff;
            border-color: #10b981; /* Emerald focus for Create */
        ...
        .glass-input:focus + .input-icon { color: #10b981; transform: scale(1.1); }
        ...
        .etheric-card-preview {
            ...
            box-shadow: 0 30px 60px -15px rgba(16, 185, 129, 0.25); /* Emerald shadow */
        ...
        /* Mesh Gradient for Preview (Emerald Theme) */
        .mesh-preview {
            background-image: radial-gradient(at 0% 0%, hsla(160,100%,40%,1) 0, transparent 50%),
                              radial-gradient(at 50% 0%, hsla(140,100%,30%,1) 0, transparent 50%),
        ...
        .btn-submit:hover { transform: translateY(-4px) scale(1.02); box-shadow: 0 25px 50px -10px rgba(16, 185, 129, 0.5); }
    ...
    <div class="lg:ml-72 flex-1 flex flex-col min-h-screen relative z-10 transition-all">
        ...
        <header class="h-20 flex items-center justify-between px-6 lg:px-10 lg:hidden bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-40">
            <div class="flex items-center gap-4">
                ...
                <span class="font-bold text-lg text-slate-900">Buat Kategori</span>
            </div>
        ...
        <div class="p-6 lg:p-12 max-w-6xl mx-auto w-full">
            ...
            <div class="flex flex-col md:flex-row justify-between items-end gap-6 mb-12" data-aos="fade-down">
                <div>
                    <h1 class="text-4xl md:text-5xl font-display font-extrabold text-slate-900 mb-3">
                        Genesis <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-600">Category</span>
                    </h1>
                    <p class="text-slate-500 text-lg">Ciptakan kategori baru untuk memperluas ekosistem event.</p>
                </div>
            ...
            <form method="POST" action="{{ route('admin.categories.store') }}"
                  ...
                  x-data="{
                      catName: '{{ old('name') }}',
                      catDesc: '{{ old('description') }}',
                      catImg: '{{ old('image') }}'
                  }">
                @csrf

                {{-- Left Column: Input Form (8 cols) --}}
                <div class="lg:col-span-8 glass-panel p-8 md:p-12 space-y-2" data-aos="fade-up">
                    <h3 class="text-xl font-bold text-slate-900 mb-8 flex items-center gap-2">
                        <i class="ph-duotone ph-plus-circle text-emerald-600"></i> Informasi Kategori
                    </h3>

                    {{-- Error Handler --}}
                    @if ($errors->any())
                        <div class="p-5 mb-6 rounded-2xl bg-rose-50 border border-rose-100 text-rose-600 text-sm shadow-sm flex gap-3 animate__animated animate__headShake">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="name" x-model="catName" class="glass-input" placeholder="Contoh: Art Exhibition" required>
                    ...
                    <div class="input-group">
                        ...
                        <textarea name="description" rows="5" x-model="catDesc" class="glass-input leading-relaxed" placeholder="Jelaskan kategori ini untuk pengguna..." style="padding-left: 1.25rem !important;" required></textarea>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <p class="text-[10px] text-slate-400 mt-2 ml-1 italic font-medium">*Kosongkan untuk menggunakan pola abstrak default.</p>
                    </div>
                ...
                <div class="lg:col-span-4 hidden lg:block" data-aos="fade-left" data-aos-delay="200">
                    <div class="preview-container">
                        ...
                        <div class="etheric-card-preview" data-tilt data-tilt-max="10" data-tilt-speed="400">
                            ...
                            {{-- Content Body --}}
                            <div class="p-8 flex-1 flex flex-col relative z-20 bg-white/30 backdrop-blur-sm">
                                <div class="flex-1">
                                ...
                                <div class="mt-8 pt-6 border-t border-slate-200/50 flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Preview Mode</span>
                                    </div>
